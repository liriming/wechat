...
/**
 * 返回ISO格式的日期字符串（去掉时分秒）
 * 如："2016-09-22T08:37:43.438Z" --> "2016-09-22T08:37:43"
 */
Date.prototype.toIsoDateTimeString = function() {
	var adjustedTime = new Date(this.getTime() - this.getTimezoneOffset()*60000); 
	return adjustedTime.toISOString().slice(0,-5);
};
...
Date.prototype.toIsoDateString = function() {
	var adjustedTime = new Date(this.getTime() - this.getTimezoneOffset()*60000); 
	return adjustedTime.toISOString().slice(0,-14);
};
